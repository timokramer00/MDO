...
x0 = [21.6,10.32,0.69,0.39,   0.2337, 0.0796,0.2683, 0.0887, 0.2789, 0.3811, -0.2254, -0.1634, -0.0470,-0.4771, 0.0735, 0.3255,0.75, 12009.12, 70400*9.81, 16, 19237.1*9.81];
...
MTOW = WAW + Wfuel + Wstr;
L = sqrt(MTOW*(MTOW-Wfuel));
CLcruise=L/(0.5*rho*V^2*A*2);
